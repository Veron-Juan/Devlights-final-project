              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full outline-none focus:outline-none bg-white">
                ...
                <div className="flex flex-row h-auto justify-between my-2 mx-2.5 pb-2 border-b ">
                    <div className="flex flex-row h-auto  ">
                      <img src={props.imgUser} className="h-8 w-8 rounded-full   "/>
                      <p className="font-semibold text-xl text-black ml-2">{props.nombreUser}</p>
                    </div>
                  ...
                  <button
                    ...
                    >
                    <Icon icon={closeIcon} className="w-5 h-8 " />  </button>
                </div>
                <div className="flex flex-row mb-2 mx-2">
                  ...
                  <p className="font-bold text-black text-xl mt-2 mb-1">{props.tituloPost}</p>
                  <p className="text-black text-sm mt-1 mb-2">{props.descripcionPost}</p> </div>
                  <button
